...
function useAnchors() {
  ...
  // Highlight it
  const positionHighlights = highlightRange(positionRange, 'span', 'position-highlight');
  ...
  // Highlight it
  const rangeHighlights = highlightRange(rangeAnchorRange, 'span', 'range-highlight');
  
  // Clean up all highlights
  setTimeout(() => {
    removeHighlights([...quoteHighlights, ...positionHighlights, ...rangeHighlights]);
  }, 5000);
}
