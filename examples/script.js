...
function enterUpdateMode(annotation) {
  ...
  annotationButton.innerHTML = '<i class="material-icons">update</i> Update Annotation';
...
function exitUpdateMode() {
  ...
  const annotationButton = document.getElementById('annotation-btn');
  annotationButton.innerHTML = '<i class="material-icons">comment</i> Create Annotation';
...
function updateAnnotation() {
  if (!selectedAnnotationId || !window.annotationsMap || !window.annotationsMap[selectedAnnotationId]) {
  ...
  const commentText = document.getElementById('annotation-comment').value.trim();
  ...
  try {
    ...
    const highlights = annotator.addHighlights(contentElement, updatedAnnotation);
