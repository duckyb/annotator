 ...
 * @param color Optional hex color code for the highlight
...
export function highlightRangeWrapper(
  ...
  // Call the original highlightRange with the HTMLElement and color
  return highlightRange(range, tag, cssClass, color);
}
